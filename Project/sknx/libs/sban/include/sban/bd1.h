 ...
 *
 * Refer to: 
 *   - Burmester, M., Desmedt, Y.: A Secure and Efficient Conference 
...
int bd1_gen_value(bd1_context *ctx, unsigned char *buf, size_t buflen,
                  size_t *olen, unsigned char *obuf, size_t obuflen,
                  void *p_rng);
...
int bd1_compute_key(bd1_context *ctx, unsigned char *buf, size_t buflen, 
                    int n, size_t *olen, unsigned char *obuf, size_t obuflen, 
                    void *p_rng);
